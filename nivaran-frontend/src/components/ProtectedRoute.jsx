...
/**
 * ProtectedRoute component for Citizen Dashboard
 ...
 * - Redirects to /login if unauthenticated or cookie invalid
 */
export default function ProtectedRoute({ children }) {
  const location = useLocation()
  const { data, isLoading, isError } = useCurrentCitizen()
    ...
    return (
      <div className="min-h-screen grid place-items-center bg-[#EEF2FF]" style={{
        ...
        >
          ...
          <p className="text-xs text-slate-400 font-semibold mt-1.5">Verifying authentication session...</p>
